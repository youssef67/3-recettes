...
class Aliment
{
     ...
     * @Assert\Length(min=3,max=15, minMessage="3 caractères minimum", maxMessage="15 caractères maximum")
     */
    private $nom;

    /**
     * @ORM\Column(type="float")
     * @Assert\Range(min=0.1, max=100, notInRangeMessage="prix entre 0.1 et 100")
     */
    private $prix;
